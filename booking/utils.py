...
class Calendar(HTMLCalendar):
    ...
    def formatday(self, day, posts):
        ...
        posts_per_day = posts.filter(start_date__lte=today_date, end_date__gte=today_date)
        d = ''
    ...
    def formatmonth(self, withyear=True):
        posts = Post.objects.filter(start_date__year=self.year, start_date__month=self.month)
